...
def _ensure_gtk():
    """Import GTK lazily so pure-logic helpers remain usable without it."""
    import gi
...
def create_network_tools_dialog(parent=None):
    """Factory function that creates and returns a NetworkToolsDialog.

    This avoids importing GTK at module level.
    """
    ...
    return NetworkToolsDialog(parent_win=parent)
